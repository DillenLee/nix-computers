...
{ imports =
  ...
  networking.hostName = "edamame"; # Define your hostname.
...
services.xserver.videoDrivers = [ "nvidia" ]; 
  ...
  users.users.dillen = { isNormalUser = true; description = "Dillen"; extraGroups = [ "networkmanager" "wheel" ]; packages = with pkgs; [
    #  thunderbird
    ];
  };
